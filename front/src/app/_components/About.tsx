      ...
      <div className={styles.aboutContent}>
        <Container variant="top" className={styles.aboutContentContainer}>
          ...
          <p className={styles.aboutContentText}>
            私は7年間、Webサイト・オウンドメディア制作の設計から実装、<br className="isPc" />
            運用までを行なってきたフロントエンドエンジニアです。<br />
            直近では Next.js／Nuxt.js を用いた開発を中心に、<br className="isPc" />
            CMS設計やAPI設計、バックエンド実装まで横断して携わっています。<br />
            単なる実装に留まらず、技術選定やアーキテクチャ設計、<br className="isPc" />
            ディレクトリ構成の標準化など、拡張性と再利用性を<br className="isPc" />
            意識した開発基盤の構築を主導しております。<br />
            将来的な運用フェーズを見据え、保守性・可読性・拡張性の高い<br className="isPc" />
            プロダクト開発を実践しています。<br />
            また、ディレクター・デザイナーと連携しながら仕様を整理し、<br className="isPc" />
            技術的観点から最適解を提案するなど他職種とのコミュニケーションや連携が得意です。<br />
            AI活用による開発効率化も推進やチーム内の勉強会開催など能動的に活動することができ、<br className="isPc" />
